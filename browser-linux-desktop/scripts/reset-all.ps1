...
<#
.SYNOPSIS
  FACTORY RESET: destroys everything — containers, workspace, database,
  desktop settings AND the seeded Git history. The next start re-seeds
  core-app.git from the seed\company-app folder.
#>
